...
def main():
    ...
    ap.add_argument("--labels", required=True, help="dir of plaintext .lbl files")
    ap.add_argument("--ecu-id", required=True, help="Supabase ecu.id to attach these to")
    args = ap.parse_args()
    ...
    print(f"✓ {total} coding definitions ingested. Now run: python ai/embeddings.py")
