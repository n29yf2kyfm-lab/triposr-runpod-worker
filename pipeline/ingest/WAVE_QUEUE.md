...
| 12 | Mazda | IN PROGRESS 2026-08-11 — 560 swept, 275 in band, 235 candidates, **150 after filtering**. Prioritised T1=8 T2=27 T3=15 T4=19 T5=81 (first MX-5 at position 72). Rendering to `audit/mazda`, staged to `staging/mazda`. **78 sheets eye-audited: 34 pass / 43 fail / 1 fail-rerender**; 30 keeps after 4 duplicate drops. Deliverables committed: `mazda_audit_verdicts.json`, `MAZDA_CLEAN.json`, `MAZDA_DUPES.json`, `MAZDA_GLASS.json`, `MAZDA_KEEP_1.csv`, `MAZDA_LICENCES_1.csv`. **The wave is resumable** — rerun the same gpu_wave command; it re-checks the bucket and skips finished sheets. Remaining rows are almost entirely T5 RX-7/RX-8/MX-5. |
